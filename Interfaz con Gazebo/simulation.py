...
from gazebo import gazebo_controller
...
class Simulation(QObject):
    ...
    _RUN_ = True
    desired_q = [0.]*6
    home_p = [0.30000024, 0.2900002, 0.13999661, -2.11982589, 1.53000467, 1.51018242]
    home_q = [0.518,-1.476,2.278,-2.394,-1.538,-3.984]
    ...
    def run(self):
        ...
        while self._RUN_:
            ...
            data = self.com.recibir(self.com.omnibundle)
            ...
            if data.any(): 
                ...
                gazebo.move(self.desired_q)

                self.robot.q = gazebo.q
                self.get_pos()
    ...
    def move_to(self, D_q):
        x, y, z, Rx, Ry, Rz = D_q
        Rx,Ry,Rz = [-2.11982589, 1.53000467, 1.51018242]
